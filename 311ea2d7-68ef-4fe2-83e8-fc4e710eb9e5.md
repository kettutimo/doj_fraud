...
First identified in August 2018, Ryuk is a type of ransomware software that, when executed on a computer or network, encrypts files and attempts to delete any system backups. Of note, Ryuk can target storage drives contained within or physically connected to a computer, including those accessible remotely via a network connection. Ryuk has been used to target thousands of victims worldwide across a variety of sectors. In October 2020, law enforcement officials specificallyhttps://www.cisa.gov/uscert/ncas/alerts/aa20-302aRyuk as an imminent and increasing cybercrime threat to hospitals and healthcare providers in the United States.
