...
According to the Complaint unsealed today:#_ftn1
...
#_ftnref1As the introductory phrase signifies, the Complaint and the description of the Complaint set forth herein constitute only allegations, and every fact described should be treated as an allegation.

/usao-sdny/file/1297591/dl?inline
