...
According to the Complaint, the Indictment,#_ftn1and statements made in court, and publicly available documents:
...
#_ftnref1****As to Rodriguez’s co-defendant Eva Christine Rodriguez, the entirety of the text of the Indictment, and the descriptions of the Indictment set forth herein constitute only allegations and every fact described should be treated as an allegation.
