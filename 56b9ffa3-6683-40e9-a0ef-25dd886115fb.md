...
As alleged in the Indictment unsealed today#_ftn1:
...
#_ftnref1As the introductory phrase signifies, the entirety of the text of the Indictments and the description of the Indictments set forth in this release constitute only allegations, and every fact described should be treated as an allegation.
