...
According to allegations in the indictments filed against APPIEDU, ASANTE, FREEMAN, ANING, and KISSI, a criminal complaint filed against ALI, and other court documents#_ftn1:
...
#_ftnref1As the introductory phrase signifies, the entirety of the Complaint and Indictment and the description of the Complaint and Indictment set forth herein constitute only allegations, and every fact described should be treated as an allegation.
